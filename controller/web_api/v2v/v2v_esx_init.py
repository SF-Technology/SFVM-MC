...
from common_data_struct import base_define, flavor_init_info,  group_info, area_dq_init_info
from service.s_ip import segment_service
from model.const_define import ErrorCode, NetCardType
import json_helper
import logging
...
class V2v_esx_InitInfoResp(base_define.Base):
...
def init_segment():
    ...
    segments_list = []
    segments_data = segment_service.get_level_info(NetCardType.INTERNAL)
