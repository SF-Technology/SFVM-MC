...
def calc_dest_host_batch(hostpool_id, vm_mem, vm_disk, group_id, count):
    '''
        筛选host
    :param hostpool_id:
    :param vm_mem:
    ...
    if not hostpool_id or not vm_mem or not vm_disk:
    ...
    if host_len == 0:
        ...
        if host_list[0] == '':
            ...
            dest_host_list = host_list
            logging.info('the suitable host for v2v has been workd out ')
            msg = "已找到匹配主机"
            data = dest_host_list
